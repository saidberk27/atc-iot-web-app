...
const schema = a.schema({
  ...
  Platform: a.model({
    ...
    platformBuildings: a.hasMany('PlatformBuilding', 'platformID'),
    platformVehicles: a.hasMany('PlatformVehicle', 'platformID'),
    createdAt: a.datetime(),
    updatedAt: a.datetime(),
  }).authorization(allow => [allow.publicApiKey()]),
  ...
  Building: a.model({
    ...
    userID: a.string().required(),
    user: a.belongsTo('User', 'userID'),
    platformBuildings: a.hasMany('PlatformBuilding', 'buildingID'),
  ...
  Vehicle: a.model({
    ...
    userID: a.string().required(),
    user: a.belongsTo('User', 'userID'),
    platformVehicles: a.hasMany('PlatformVehicle', 'vehicleID'),
    units: a.hasMany('Unit', 'vehicleID'),
    createdAt: a.datetime(),
    updatedAt: a.datetime(),
  }).authorization(allow => [allow.publicApiKey()]),

  PlatformBuilding: a.model({
    id: a.id(),
    platformID: a.string().required(),
    buildingID: a.string().required(),
